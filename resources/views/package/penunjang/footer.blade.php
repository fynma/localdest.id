  <footer class="bg-white dark:bg-gray-900 w-full  bottom-0 mt-20   ">
        <div class="mx-auto w-full">
            ...
            <div class="sm:flex sm:items-center sm:justify-between p-4" style="background: #026AA2">
                <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a
                        href="https://flowbite.com/" class="hover:underline">LocalDest.id</a>. All Rights Reserved.
                </span>
